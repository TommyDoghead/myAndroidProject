package com.doghead.myandroidproject;
 ...
 */
public class MyAndroidProjectActivity extends SimpleBaseGameActivity {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	protected int mCactusCount, mCactusCount2;
	protected float mCactusCount3, mCactusCount4;
	...
	public Scene onCreateScene() {
		...
		try {
			...
			this.mTMXTiledMap = tmxLoader.loadFromAsset("tmx/4040.tmx");			
		...
		/*Check size of things*/
		MyAndroidProjectActivity.this.mCactusCount3 = mPlayerTextureRegion.getWidth();
		MyAndroidProjectActivity.this.mCactusCount4 = mPlayerTextureRegion.getHeight();
		
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(MyAndroidProjectActivity.this, "" + MyAndroidProjectActivity.this.mCactusCount3, Toast.LENGTH_LONG).show();
				Toast.makeText(MyAndroidProjectActivity.this, "" + MyAndroidProjectActivity.this.mCactusCount4, Toast.LENGTH_LONG).show();
			}
		});
		...
		final Path path = new Path(5).to(0, 0).to(0, 1240).to(1240, 1240).to(1240, 0).to(0, 0);
